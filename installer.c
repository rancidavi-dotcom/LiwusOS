...
extern void start_installation();
...
void draw_installer_full() {
    ...
    switch ((install_step_t)step) {
        case STEP_WELCOME_DISK:
            ...
            draw_button_visual(cx, cy + 40, 400, 40, "/dev/hda (100MB QEMU HARDDISK)", 0x555555);
        ...
        case STEP_CONFIRM:
            draw_string(cx, cy, "Tem certeza que deseja instalar o LiwusOS no disco /dev/hda?", 0xFFFFFF);
