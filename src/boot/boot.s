...
mb2_tags_start:
  /* Information request tag (Type 1): pede ao GRUB as tags de ACPI.
   * Tag 14 = RSDP antigo (v1), Tag 15 = RSDP novo (v2). Necessário
   * para descobrir tabelas ACPI sob UEFI, onde a varredura legada falha.
   */
  .align 8
  .word 1      /* type */
  .word 0      /* flags */
