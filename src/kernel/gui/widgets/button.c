...
static void button_draw(node_t *self, struct gui_renderer *r) {
    ...
    /* Win95 3D bevel: black outer ring + white hilite top/left,
       gray shadow bottom/right (inverted while pressed). */
    ...
    if (!d->pressed) {
        /* Raised: white top/left, gray bottom/right */
        ...
        /* Sunk: gray top/left, white bottom/right */
    ...
    /* Black outer ring */
    renderer_fill_rect(r, rect_make(screen_x - 1, screen_y - 1, screen_w + 2, 1), black);
    renderer_fill_rect(r, rect_make(screen_x - 1, screen_y, 1, screen_h), black);
    renderer_fill_rect(r, rect_make(screen_x - 1, screen_y + screen_h, screen_w + 2, 1), black);
    renderer_fill_rect(r, rect_make(screen_x + screen_w, screen_y, 1, screen_h), black);
