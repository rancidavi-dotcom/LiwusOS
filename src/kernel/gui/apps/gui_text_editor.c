...
static void editor_start_with_file(const char *path) {
    ...
    node_t *toolbar = panel_create("editor_toolbar", 0, 0, 680, 36, 0xFF2D333D);
    ...
    node_t *footer = panel_create("editor_footer", 0, 0, 680, 26, 0xFF252A33);
    ...
    g_editor->status_label = label_create("editor_status", 0, 0, "Pronto", 0xFF99A1AF);
